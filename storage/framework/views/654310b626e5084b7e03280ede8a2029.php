<?php $__env->startSection('content'); ?>
    ...
    <section class="relative bg-slate-950 section-padding overflow-hidden">
        <div class="absolute inset-0">
            <img src="<?php echo e(asset('images/pexels-pixabay-209271.jpg')); ?>" alt="" class="w-full h-full object-cover opacity-40">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                ...
                <div class="lg:col-span-6 space-y-6" data-aos="fade-left" data-aos-delay="150">
                    <div class="relative rounded-3xl overflow-hidden shadow-2xl shadow-slate-900/10">
                        <img src="<?php echo e(asset('images/pexels-tima-miroshnichenko-6197108.jpg')); ?>" alt="Zespół Alluc Cleaning" class="w-full h-64 object-cover">
                    </div>
                    <div class="relative rounded-3xl overflow-hidden shadow-xl">
                        <img src="<?php echo e(asset('images/pexels-ron-lach-10567353.jpg')); ?>" alt="Profesjonalny sprzęt" class="w-full h-48 object-cover">
    ...
    <section class="section-padding bg-slate-50">
        <div class="container-max mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="text-center p-6 rounded-3xl bg-white border border-slate-100 hover:shadow-xl transition-all duration-500" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                    <div class="w-14 h-14 bg-blue-900 rounded-2xl flex items-center justify-center mx-auto mb-5">
                        <svg class="w-7 h-7 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($item['icon']); ?>"/></svg>
                    </div>
                    <h3 class="font-display text-lg font-bold text-slate-900 mb-2"><?php echo e($item['title']); ?></h3>
    ...
    <section class="section-padding bg-blue-900 relative overflow-hidden">
        <div class="absolute inset-0 opacity-10">
            <img src="<?php echo e(asset('images/pexels-tima-miroshnichenko-6196689.jpg')); ?>" alt="" class="w-full h-full object-cover">
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/o-nas.blade.php ENDPATH**/ ?>