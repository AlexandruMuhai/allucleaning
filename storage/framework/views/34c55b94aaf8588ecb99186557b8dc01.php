...
<?php $__env->startSection('header', 'Dodaj użytkownika'); ?>
...
unset($__errorArgs, $__bag); ?>">
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($role->value); ?>" <?php echo e(old('role') == $role->value ? 'selected' : ''); ?>><?php echo e($role->label()); ?></option>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/users/create.blade.php ENDPATH**/ ?>