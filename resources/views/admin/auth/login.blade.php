...
<head>
    ...
    <title>Logowanie — {{ config('app.name') }}</title>
        ...
        <div class="relative flex w-full flex-col justify-center px-6 py-12 lg:w-1/2">
            ...
            <div class="mx-auto w-full max-w-md text-center">
                <a href="{{ route('home') }}" class="mb-8 inline-block">
                    <img src="{{ asset('images/logo.png') }}" alt="Alluc Cleaning" class="mx-auto h-14 w-auto">
                </a>
                ...
                <div class="mt-8">
                    <form method="POST" action="{{ route('admin.login.store') }}">
                        ...
                        <div class="mb-6 flex items-center justify-between">
                            ...
                            <a href="{{ route('admin.password.request') }}" class="text-sm font-medium text-emerald-600 transition-colors hover:text-emerald-700">
                                Zapomniałeś hasła?
                            </a>
                        </div>
