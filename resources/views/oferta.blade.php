...
@section('content')
    ...
    <section class="relative bg-slate-950 section-padding overflow-hidden">
        <div class="absolute inset-0">
            <img src="{{ asset('images/pexels-ron-lach-10567353.jpg') }}" alt="" class="w-full h-full object-cover opacity-40">
    ...
    {{-- Service 1: Biura — Asymmetric layout --}}
        ...
        <div class="container-max mx-auto relative">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-5" data-aos="fade-right">
                    ...
                    <ul class="space-y-4">
                        @foreach(['Sprzątanie codzienne lub kilka razy w tygodniu — Ty ustalasz harmonogram', 'Mycie podłóg, odkurzanie, czyszczenie łazienek i kuchni', 'Opróżnianie koszy, uzupełnianie środków higieny', 'Prace realizowane po godzinach pracy biura — bez zakłóceń', 'Profesjonalne środki czystości w cenie usługi'] as $item)
                ...
                {{-- Right: Image with offset for asymmetry --}}
                <div class="lg:col-span-7 lg:pl-8" data-aos="fade-left" data-aos-delay="150">
                    <div class="relative">
                        <div class="rounded-3xl overflow-hidden shadow-2xl shadow-slate-900/10">
                            <img src="{{ asset('images/pexels-cottonbro-5483052.jpg') }}" alt="Sprzątanie biur" class="w-full h-80 lg:h-[28rem] object-cover">
                        </div>
    ...
    {{-- Service 2: Klatki — Reversed asymmetric --}}
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-6" data-aos="fade-right" data-aos-delay="100">
                    <div class="relative">
                        <div class="rounded-3xl overflow-hidden shadow-2xl shadow-slate-900/10" style="clip-path: polygon(0 0, 100% 0, 100% 85%, 85% 100%, 0 100%);">
                            <img src="{{ asset('images/pexels-sliceisop-4737704.jpg') }}" alt="Klatki schodowe" class="w-full h-80 lg:h-[30rem] object-cover">
                        </div>
                        {{-- Floating stat --}}
                ...
                <div class="lg:col-span-6" data-aos="fade-left" data-aos-delay="200">
                    ...
                    <ul class="space-y-4 mb-10">
                        @foreach(['Mycie klatek schodowych, wind i korytarzy', 'Czyszczenie domofonów, poręczy i drzwi wejściowych', 'Usuwanie graffiti i niepożądanych naklejek', 'Sprzątanie piwnic, strychów i wózkowni', 'Zimą — odśnieżanie wejść i chodników'] as $item)
                        <li class="flex items-start gap-3">
                            <svg class="w-5 h-5 text-emerald-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            <span class="text-slate-600">{{ $item }}</span>
                        </li>
                    ...
                    <div class="bg-blue-900 rounded-2xl p-6 text-white">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            @foreach(['Przejrzyste stawki', 'Brak ukrytych kosztów', 'Dedykowany opiekun', 'Elastyczne płatności'] as $feat)
                        ...
                        <a href="{{ route('kontakt') }}" class="btn-primary mt-6 text-sm py-2.5 px-5">Zapytaj o ofertę</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="{{ $loop->index * 80 }}">
                    <div class="w-12 h-12 bg-emerald-50 rounded-2xl flex items-center justify-center mx-auto mb-3 border border-emerald-100">
                        <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $item['icon'] }}"/></svg>
                    </div>
                    <p class="font-display font-bold text-slate-900 text-lg">{{ $item['value'] }}</p>
        ...
        <div class="container-max mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div class="glass rounded-3xl p-8 border border-white/40 hover:shadow-2xl transition-all duration-500 hover:-translate-y-1" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <a href="{{ route('kontakt') }}" class="w-full btn-primary text-center text-sm py-3">Zamów wycenę</a>
                </div>

                {{-- Card 2: Klatki — Featured --}}
                <div class="glass rounded-3xl p-8 border-2 border-blue-900/30 hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 relative" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <a href="{{ route('kontakt') }}" class="w-full bg-blue-900 hover:bg-blue-800 text-white font-semibold text-center text-sm py-3 rounded-xl transition-all hover:-translate-y-0.5">
                        Zapytaj o ofertę
                    </a>
                </div>
            </div>
    ...
    <section class="section-padding bg-slate-50">
        <div class="container-max mx-auto text-center" data-aos="zoom-in">
            ...
            <a href="{{ route('kontakt') }}" class="btn-primary text-base px-10 py-4">Skontaktuj się z nami</a>
        </div>
    </section>
@endsection
