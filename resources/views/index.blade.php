...
@section('content')
    {{-- Hero Section with Three.js Soap Bubbles --}}
    ...
    <section class="section-padding bg-slate-50">
        <div class="container-max mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-6 gap-5" data-aos="fade-up" data-aos-delay="100">
                {{-- Biura: Large card (spans 4 cols) --}}
                <div class="md:col-span-4 bento-card bg-white shadow-sm border border-slate-100">
                    <div class="relative h-56 overflow-hidden">
                        <img src="{{ asset('images/pexels-cottonbro-5483052.jpg') }}" alt="Sprzątanie biur" class="w-full h-full object-cover hover:scale-105 transition-transform duration-700">
                    ...
                    <div class="p-8">
                        ...
                        <a href="{{ route('oferta') }}" class="text-emerald-600 font-semibold hover:text-emerald-700 inline-flex items-center gap-2 group">
                            Dowiedz się więcej
                ...
                {{-- Klatki: Tall card (spans 2 cols, 2 rows) --}}
                <div class="md:col-span-2 md:row-span-2 bento-card bg-slate-900 text-white relative overflow-hidden">
                    <div class="absolute inset-0">
                        <img src="{{ asset('images/pexels-sliceisop-4737704.jpg') }}" alt="Klatki schodowe" class="w-full h-full object-cover opacity-40">
                    </div>
                    <div class="relative z-10 h-full flex flex-col justify-end p-8">
                        ...
                        <a href="{{ route('oferta') }}" class="text-emerald-400 font-semibold inline-flex items-center gap-2 group">
                            Dowiedz się więcej
                            <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                        </a>
                    </div>
                ...
                <div class="md:col-span-2 bento-card bg-gradient-to-br from-emerald-600 to-emerald-700 text-white p-8 flex flex-col justify-center">
                    ...
                    <a href="{{ route('kontakt') }}" class="inline-flex items-center justify-center px-6 py-3 bg-white text-emerald-700 font-semibold rounded-xl hover:bg-emerald-50 transition-all text-sm">
                        Zamów wycenę
    ...
    <section class="section-padding bg-blue-900 relative overflow-hidden">
        <div class="absolute inset-0 opacity-10">
            <img src="{{ asset('images/pexels-ron-lach-10567353.jpg') }}" alt="" class="w-full h-full object-cover">
        </div>
